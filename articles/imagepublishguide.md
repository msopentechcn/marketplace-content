...
3. 准备发布前资料。请参考 [发布商入驻指南](https://market.azure.cn/Documentation/article/publishguide/) ；准备好虚拟机镜像文件，参考 [虚拟机镜像制作](https://market.azure.cn/Documentation/article/imageguide/)。
