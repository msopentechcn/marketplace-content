...
##### 使用putty远程登录服务器
	...
	chanzhiEPS访问地址为：http://{DnsName}.chinacloudapp.cn/www/
	chanzhiEPS管理后台访问地址为：http://{DnsName}.chinacloudapp.cn/www/admin.php
...
##### 程序安装位置
	...
	chanzhiEPS 5.3.2	/opt/apache/htdocs/www
